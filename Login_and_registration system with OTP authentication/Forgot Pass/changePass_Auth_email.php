...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method = "POST" field = "hidden" action="changePass_Auth_secQues.php" class="login100-form validate-form">
					<span class="login100-form-title">
						Authentication
					</span>

					<h5 class="login100-form-title"> Enter your Email </h5>
	...
	<!-- <script>
		function sry(){
			...
			window.locate = 'changePass_Auth_secQues.php';
		}
	</script> -->
